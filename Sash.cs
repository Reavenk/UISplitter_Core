...
{ 
    /// <summary>
    /// The sash for the UIUtils.Splitter class.
    /// This should not be authored in the editor, but auto-created by Splitter.
    /// 
    ...
    { 
        ...
        public static Action<SplitterSash, State> OnBeginDrag = null;
        public static Action<SplitterSash, State> OnEndDrag = null;
        public static Action<SplitterSash, State> OnHoverEnter = null;
        public static Action<SplitterSash, State> OnHoverExit = null;
        ...
        void ClearState()
        { 
            bool wasHovered = (this.state & State.Hovering) != 0;
            bool wasDragging = (this.state & State.Dragging) != 0;
            this.state = 0;
            if(wasHovered)
                OnHoverExit?.Invoke(this, this.state);
            if(wasDragging)
                OnEndDrag?.Invoke(this, this.state);
        }
        ...
        { 
            ...
            OnBeginDrag?.Invoke(this, this.state);
        }
        ...
        void UnityEngine.EventSystems.IPointerEnterHandler.OnPointerEnter(UnityEngine.EventSystems.PointerEventData eventData)
        {
            ...
            OnHoverEnter?.Invoke(this, this.state);
        }
